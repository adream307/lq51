...
#define lqFlgMax		2			/*标志事件个数，最多只能建立16个*/
#define lqSemMax		2			/*定义信号量个数，最多只能建立16个信号量*/
#define lqMsgMax		1			/*定义邮箱个数，最多只能建立16个邮件*/

#define LQ_DELAY_EN			1		/*任务延迟*/
#define LQ_FLG_EN			0		/*标志事件*/
...
#if	LQ_FLG_EN			/*标志事件*/
extern char lqWaitFlg(unsigned char index,unsigned char tmo);
